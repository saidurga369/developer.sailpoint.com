...
export const navigation = [
  {
    ...
    content: [
      ...{
        ...
        name: 'Account List',
        description: 'an example showcasing how to list accounts',
        icon: ReportsSvg,
      },
    ],
  },
...
:::info You can add a custom SVG icon for each sidebar item. Save and import your icon svg under `lib/Components/SVGs/*`. :::
