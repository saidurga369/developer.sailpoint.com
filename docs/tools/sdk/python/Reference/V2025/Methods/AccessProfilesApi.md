...
tags:
  ['SDK', 'Software Development Kit', 'Access_Profiles', 'V2025Access_Profiles']
---
...
| Query | include_unsegmented | **bool** | (optional) (default to True) | Indicates whether the response list should contain unsegmented access profiles. If `for-segment-ids` is absent or empty, specifying _include-unsegmented_ as `false` results in an error. |
