...
Create a source folder named "src". The SDK will include the "src/\*_/_" folder path when it compiles, so your SDK file must be there. Run this command to create the "src" folder:
...
:::warning Please ensure this file is ignored in your version control system (ex. .gitignore for git) :::
