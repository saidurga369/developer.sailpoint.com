...
keywords:
  ['go', 'Golang', 'sdk', 'CertificationCampaigns', 'CertificationCampaigns']
...
Activate a campaign Use this API to submit a job to activate the certified campaign with the specified ID. The campaign must be staged.
...
| **type\_** | [**ReportType**](../models/) | Type of the report to run. |
...
Update a campaign Use this API to update individual fields on a certification campaign, using the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.
