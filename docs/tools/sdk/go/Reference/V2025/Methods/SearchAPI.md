...
| **index** | **string** | The index from which to fetch the specified document. The currently supported index names are: _accessprofiles_, _accountactivities_, _entitlements_, _events_, _identities_, and _roles_. |
