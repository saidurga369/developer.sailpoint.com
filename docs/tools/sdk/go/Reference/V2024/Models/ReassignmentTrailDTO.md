...
keywords:
  ['go', 'Golang', 'sdk', 'ReassignmentTrailDTO', 'V2024ReassignmentTrailDTO']
...
GetPreviousOwnerOk returns a tuple with the PreviousOwner field if it's non-nil, zero value otherwise and a boolean to check if the value has been set.
