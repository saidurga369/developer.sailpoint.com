...
| Name | Type | Description | Notes |
| --- | --- | --- | --- |
| **requestedFor** | **string** | The identity that the activity was requested for. _me_ indicates the current user. Mutually exclusive with _regarding-identity_. |
| **requestedBy** | **string** | The identity that requested the activity. _me_ indicates the current user. Mutually exclusive with _regarding-identity_. |
| **regardingIdentity** | **string** | The specified identity will be either the requester or target of the account activity. _me_ indicates the current user. Mutually exclusive with _requested-for_ and _requested-by_. |
| **type\_** | **string** | The type of account activity. |
